...
public class ServiceProtocolFragment extends BaseFragment<FragmentServiceProtocolBinding> {
    ...
    @NonNull
    @Override
    protected FragmentServiceProtocolBinding viewBindingInflate(@NonNull LayoutInflater inflater, ViewGroup container, boolean attachToRoot)  {
